...
# 1. Dodac kolejnosc
# 2. Zrobic zad. 3-4
# 3. Kopiec: https://stackoverflow.com/questions/45892736/python-heapq-how-do-i-sort-the-heap-using-nth-element-of-the-list-of-lists
...
def schrageWithHeap(zad):
    ...
    while len(G) != 0 or len(N) != 0:
        ...
        if len(G) != 0:
            ...
            temp[0], temp[2] = temp[2], temp[0]*-1
            ##largest = temp.reverse()
            ###largest = temp[::-1]
            pi.append(temp)
            t = t + temp[1]
        else:
